// Dynamic Permissions Matrix System
class DynamicPermissionsUI {
  constructor() {
...
// Global instance
window.dynamicPermissionsUI = new DynamicPermissionsUI();

// Auto-initialize
document.addEventListener('DOMContentLoaded', async () => {
  try {
    await dynamicPermissionsUI.initialize();
  } catch (error) {
    console.error('Dynamic UI initialization failed:', error);
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = DynamicPermissionsUI;
}
